                            ...
                            <div class="col-lg-10 col-xl-8">
                                <div class="cart-container">
                                                ...
                                                <form method="post" action="{{ route('cart.store') }}">
                                                    ...
                                                    @foreach($cartData as $value)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ₹ {{ !empty($value->getProductData->sale_price) ? $value->getProductData->sale_price : $value->getProductData->price }}</td>
                                                            <td class="text-right">
                                                                ₹ {{ !empty($value->getProductData->sale_price) ? ($value->getProductData->sale_price * $value->quantity) : ($value->getProductData->price * $value->quantity) }}</td>
                                                        </tr>
                                                @endforeach
                                    ...
                                    <div class="cart-footer text-right">
                                        ...
                                        <a href="{{ route('store_order') }}" class="btn btn-outline-success my-1"><i
