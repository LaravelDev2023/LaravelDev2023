...
<div class="container">
<div class="row gutters" style="margin-top:78px;">
...
<div class="card h-100">
	<div class="card-body">
		<div class="account-settings">
			...
			<form method="POST" action="{{route('update_user_image',['id' => $user->id])}}" enctype="multipart/form-data">
                     @csrf
			<div class="user-profile">
			<div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="radio" id="gender" name="role_id" value="1" @if($user->role_id == '1') {{'checked'}} @endif >Admin
                                <input type="radio" id="gender" name="role_id" value="0" @if($user->role_id == '0') {{'checked'}} @endif>User
                            </div>
